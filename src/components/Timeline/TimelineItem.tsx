...
const TimelineItem = ({company, time, role, description}: ExperienceProps) => {
  ...
  return (
    <div className="relative pl-8 sm:pl-32 pt-6 last:pb-6 group md:w-full bg-white">
          {/* Dot - Label */}
          ...
          <motion.div
            ...
            viewport={{once: true}}
            // whileHover={{}}
            className="pt-2 pb-1 bg-white text-gray-900 border-l-8 transition border-[1px]  hover:tracking-normal px-4 pr-8 rounded-sm  border-transparent whitespace-pre-wrap font-mono font-normal text-md leading-loose relative">
