      ...
      <div className="w-full sm:max-w-screen-sm md:max-w-screen-md  lg:max-w-screen-xl pt-8">
        ...
        <AnimateChangeInHeight className="text-lg">
          <p className="py-8">
            ...
            6 years of experience. I'm passionate about crafting user-friendly
            and performant web applications. I started my tech career role as a
            back-end developer,where I honed my problem-solving skills, which I
            now leverage to continuously improve the user experience through
