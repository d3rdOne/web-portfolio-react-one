...
const SkillCard = ({imageUrl ,name, link, level, maxLevel}: SkillCardProps) => {
  ...
  return (
    <motion.a
      ...
      className="flex justify-start items-center flex-col p-1 mt-2 hover:scale-105 transition sm:border-2 sm:border-gray-700 sm:bg-white min-w-20  sm:min-w-32 sm:max-w-32 h-24 sm:h-32 sm:shadow-xs sm:p-2">
